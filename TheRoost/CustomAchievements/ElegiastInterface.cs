...
namespace TheRoost
{
    internal class AchievementInterfaceManager
    {
        ...
        private void SetAchievementEntry(IFucineAchievement achievement, ref int achievementNum, CultureInfo culture)
        {
            ...
            {
                TheRoost.Sing("Non-existing category '{0}' for achievement '{1}'", achievement.category, achievement.label);
                return;
            }
...
//dump
/*
static List<string> achs = new List<string> { "A_CULT_LANTERN", "A_ENDING_DESPAIRENDING", "A_ENDING_DEATHOFTHEBODY", "A_MANSUS_WOOD", "A_MANSUS_WHITEDOOR", "A_ENDING_WINTERSACRIFICE", "A_CULT_FORGE", "A_CULT_GRAIL", "A_CULT_KNOCK",
"A_CULT_SECRETHISTORIES", "A_MANSUS_STAGDOOR",  "A_ENDING_WORKVICTORY", "A_ENDING_WORKVICTORYB", "A_ENDING_ARREST", "A_SUMMON_GENERIC", "A_MANSUS_SPIDERDOOR", "A_ENDING_VISIONSENDING",
"A_CULT_MOTH", "A_MANSUS_PEACOCKDOOR", "A_CULT_WINTER", "A_CULT_HEART", "A_PROMOTED_EXALTED_LANTERN", "A_ENDING_MINORLANTERNVICTORY", "A_CULT_EDGE", "A_PROMOTED_EXALTED_GRAIL", 
"A_ENDING_MINORFORGEVICTORY", "A_PROMOTED_EXALTED_FORGE", "A_ENDING_MINORGRAILVICTORY", "A_PROMOTED_EXALTED_MOTH", "A_ENDING_WORKVICTORYMARRIAGE", "A_PROMOTED_EXALTED_KNOCK",
"A_PROMOTED_EXALTED_WINTER", "A_PROMOTED_EXALTED_HEART", "A_ENDING_FOECAUGHTUP", "A_PROMOTED_EXALTED_EDGE", "A_MANSUS_TRICUSPIDGATE", "A_ENDING_MINORWINTERVICTORY", "A_ENDING_MINORMOTHVICTORY", "A_ENDING_MINORHEARTVICTORY", "A_ENDING_MAJORFORGEVICTORY", "A_ENDING_MINORCROWNEDGROWTHVICTORY", "A_ENDING_MINORKNOCKVICTORY", "A_ENDING_MAJORLANTERNVICTORY",
"A_ENDING_MAJORGRAILVICTORY", "A_ENDING_OBSCURITYVICTORYA", "A_ENDING_MINORMENISCATEVICTORY", "A_ENDING_CATVICTORY", "A_ENDING_MINORLANTERNVICTORY_WITHRISEN", "A_ENDING_MINORFORGEVICTORY_WITHRISEN", "A_ENDING_ENIDVICTORY", "A_ENDING_MINORMAREVICTORY", "A_ENDING_RENIRAVICTORY", "A_ENDING_OBSCURITYVICTORYA_FOESLAIN", "A_ENDING_MINORGRAILVICTORY_WITHRISEN", "A_ENDING_OBSCURITYVICTORYC_FOESLAIN", "A_ENDING_MINORMENISCATEVICTORY_WITHRISEN", "A_ENDING_COLONEL", "A_ENDING_MINORMOTHVICTORY_WITHRISEN", "A_ENDING_LIONSMITH", "A_ENDING_VICTORVICTORY", "A_ENDING_MINORHEARTVICTORY_WITHRISEN", "A_ENDING_AUCLAIRVICTORY", "A_ENDING_TRISTANVICTORY", "A_ENDING_VALCIANEVICTORY", "A_ENDING_LAIDLAWVICTORY", "A_ENDING_ELRIDGEVICTORY", "A_ENDING_ROSEVICTORY", "A_ENDING_SALIBAVICTORY", "A_ENDING_LEOVICTORY", "A_ENDING_VIOLETVICTORY", "A_ENDING_NEVILLEVICTORY", "A_ENDING_CLIFTONVICTORY", "A_ENDING_SLEEVICTORY", "A_ENDING_PORTERVICTORY", "A_ENDING_YSABETVICTORY", "A_ENDING_SYLVIAVICTORY", "A_ENDING_CLOVETTEVICTORY", "A_ENDING_DOROTHYVICTORY", "A_ENDING_OBSCURITYVICTORYC", "A_ENDING_OBSCURITYVICTORYB_FOESLAIN", "A_ENDING_WOLF", "A_ENDING_VELVET", "A_ENDING_OBSCURITYVICTORYB", };
        static void dump()
        {
            string[] sumfin = System.IO.File.ReadAllLines(Application.persistentDataPath + "/1.txt");
            
            List<string> data = new List<string>();
            foreach (string str in sumfin)
                if (str.Contains("<h3>") || str.Contains("<h5>"))
                    data.Add(str.Trim().Remove(0, 4).Replace("</h3>", string.Empty).Replace("</h5>", string.Empty));

            string format = "\"id\": \"{0}\", \"label\": \"{1}\",\n \"description\": \"{2}\"";
            string result = "{\"vachievements\": [\n";
            foreach (string ach in achs)
            {
                result += " { " + String.Format(format, ach, data[0], data[1]) + " },\n";
                data.RemoveAt(0); data.RemoveAt(0);
            }
            TheRoost.Sing("sosat");
            System.IO.File.WriteAllText(Application.persistentDataPath + "1.json", result + "]}");
}
*/