namespace Roost.Piebald
{
    ...
    /// </summary>
    public class RectTransformWidget : RectTransformWidget<RectTransformWidget>
    {
        public RectTransformWidget(string key) : base(key) { }
        public RectTransformWidget(GameObject gameObject) : base(gameObject) { }
    }

    /// <summary>
    /// A base class for UI widgets that siz themselves based on its parent through use of a <see cref="RectTransform"/>.
    /// </summary>
    public abstract class RectTransformWidget<TCoreType> : UIGameObjectWidget<TCoreType>
