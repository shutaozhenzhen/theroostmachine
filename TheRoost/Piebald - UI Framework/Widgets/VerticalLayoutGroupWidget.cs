namespace Roost.Piebald
{
    ...
    /// <summary>
    /// A UI widget that arranges its children vertically.
    /// </summary>
    public class VerticalLayoutGroupWidget : VerticalLayoutGroupWidget<VerticalLayoutGroupWidget>
    {
        public VerticalLayoutGroupWidget(string key) : base(key) { }
        public VerticalLayoutGroupWidget(GameObject gameObject) : base(gameObject) { }
    }
